...
#
path <- "C:/Users/Chris/Coursework/UDACITY/UD651-DataAnalysisWithR/Project"
setwd(path)
df <- read.csv("campaign-contributions-ohio-2012.csv",
               header = TRUE, row.names = NULL)
# columns shifted to right during import
...
#
#nrow(subset(df, amount < 0))
df$amount <- ifelse(df$amount < 0, (-1)*df$amount, df$amount)
...
# have to specify dplyr to call select correctly here
