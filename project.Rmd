...
We have long-tailed data for the amount of contributions. There are so many contributions made under $1,000 that it's hard to see any of the outliers.  A logarithmic transformation of the x-axis, however, reveals more of a log-normal distribution for the amount.
...
```{r}
p0 <- ggplot(data = df, aes(x = population)) +
  geom_histogram()
...
p4 <- ggplot(data = df, aes(x = pcnt_hsp)) +
  geom_histogram()
grid.arrange(p0, p1, p2, p3, p4, layout_matrix = rbind(c(1,1), c(2,3), c(4,5)))
```
